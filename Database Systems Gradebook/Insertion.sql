...
VALUES
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Ross'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Participation'), 23),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Ross'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Final'), 92),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Wright'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Participation'), 24),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Wright'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Final'), 98),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Kanu'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Participation'), 25),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Kanu'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Final'), 87),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Adams'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Participation'), 20),
    ...
    ((SELECT STUDENT_ID from STUDENT WHERE STUDENT_LNAME ='Adams'), (SELECT ASSIGNMENT_ID from ASSIGNMENT WHERE ASSIGNMENT_NAME = 'Final'), 93);
