...
CREATE TABLE ENROLLMENT (
    ...
    FOREIGN KEY (CRS_NUM) REFERENCES COURSE (CRS_NUM) ON UPDATE CASCADE ON DELETE NO ACTION);
...
CREATE TABLE GRADE (
    ...
    FOREIGN KEY (ASSIGNMENT_ID) REFERENCES ASSIGNMENT (ASSIGNMENT_ID) ON UPDATE CASCADE);
GO
